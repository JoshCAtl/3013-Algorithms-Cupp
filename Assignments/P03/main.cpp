...
// Label:            P03
// Title:            Program 3 - Trie Tree time
// Course:           3013
// Semester:         Spring 2022
//
// Description:
//       This program takes a dictionary into a trie and times how 
//       long it takes to load the words. The purpose is to test the
...
int main() 
{
    ...
    while((k = getch()) != 'Z') 
    {
        ...
        // Tests for a backspace and if pressed deletes(shift+backspace)
        // last letter
        if ((int)k == 8) 
        {
            if (word.size() > 0) 
        ...
        cout << "Current Word: " << termcolor::bright_red << word << "\n\n";
        cout << termcolor::bright_cyan << matches.size() << " words found in " 
            << T.Seconds() << " seconds.\n";
